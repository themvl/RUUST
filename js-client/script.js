...
const HASH = new Uint8Array([112, 206, 105, 137, 76, 65, 104, 85, 67, 16, 169, 191, 86, 204, 139, 113, 76, 103, 124, 187, 165, 70, 255, 45, 9, 87, 184, 137, 71, 133, 182, 124]);

async function connectiontest() {
  //create webtransport instance 
  let transport = new WebTransport('https://127.0.0.1:4433', 
